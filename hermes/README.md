...
| profile | description |
|---|---|
| `jv-migration` | JVM→kotoba 移行専任。org 内に残る JVM (clojure CLI/JVM-only) 依存を kotoba(nbb/amu |
| `kbb-migrator` |  |
| `sec-audit` | セキュリティ監査担当。kotoba-lang org と com-junkawasaki 配下の脆弱性評価、GitHub セキュリティ設定(secret |
| `sec-sentinel` |  |
